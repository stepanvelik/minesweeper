...
def main():
    ...
    cards=[("КРЕСТИКИ-НОЛИКИ", "Игра на одном экране или по Wi-Fi", True), ("САПЁР", "Уже запущен в отдельном окне", False), ("НОВАЯ ИГРА", "Свободный слот для будущей мини-игры", False)]
    while running:
